...
<!-- Migrated from omnibase_core:docs/guides/templates/REDUCER_NODE_TEMPLATE.md on 2026-09-02 -->
...
REDUCER nodes return `projections[]` only. All other output fields are forbidden and will raise `ModelOnexError` at construction time. See Handler Output Constraints.
