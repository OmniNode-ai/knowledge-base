...
status: current
date: "2026-09-02"
title: "Effect Subcontract Guide"
topics:
  - omnibase-core
  - effect
  - subcontracts
...
<!-- Migrated from omnibase_core:docs/guides/EFFECT_SUBCONTRACT_GUIDE.md on 2026-09-02 -->
...
- **Node Building Guide**: `docs/guides/node-building/04_EFFECT_NODE_TUTORIAL.md`
- **ONEX Four-Node Architecture**: `docs/architecture/ONEX_FOUR_NODE_ARCHITECTURE.md`
- **Migration to Declarative Nodes**: `docs/guides/MIGRATING_TO_DECLARATIVE_NODES.md`
