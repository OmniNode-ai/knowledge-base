...
status: current
date: "2026-09-02"
title: "Introspection Subcontract Guide"
topics:
  - omnibase-core
  - introspection
  - subcontract
...
<!-- Migrated from omnibase_core:docs/contracts/INTROSPECTION_SUBCONTRACT_GUIDE.md on 2026-09-02 -->
...
introspection:
  ...
  allowed_introspection_sources:
    - "192.0.2.0/24"
    - "10.0.0.0/8"  # doc-content-ok illustrative RFC1918 CIDR range in a config example, not a host trace
  exclude_field_patterns:
    - password
    - secret
    - token
