...
<!-- Migrated from omnibase_core:docs/guides/templates/COMPUTE_NODE_TEMPLATE.md on 2026-09-02 -->
...
class TestHandlerValidation:
    ...
    async def test_valid_data_passes(self) -> None:
        ...
        result = await handler.handle(
            {"user_id": "u1", "email": "a@b.com"},  # sanitization-ok: illustrative example value, not a real address
            rules,
