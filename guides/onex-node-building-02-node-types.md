...
<!-- Migrated from omnibase_core:docs/guides/node-building/02_NODE_TYPES.md on 2026-09-02 -->
...
**Prerequisites**: What is a Node?
**Next**: COMPUTE Node Tutorial
...
> **v0.4.0 Update**: `NodeReducer` is now the PRIMARY implementation using the Pure FSM pattern. Legacy aggregation-focused implementations have been removed from the codebase. See MIGRATING_TO_DECLARATIVE_NODES.md for migration guidance.
...
> **Learn More**: See ONEX_FOUR_NODE_ARCHITECTURE.md for complete Intent/Action patterns and FSM implementation details.
...
> **v0.4.0 Update**: `NodeOrchestrator` is now the PRIMARY implementation using the ModelAction pattern with lease-based coordination. Legacy workflow implementations have been removed from the codebase. See MIGRATING_TO_DECLARATIVE_NODES.md for migration guidance.
...
> **Learn More**: See ONEX_FOUR_NODE_ARCHITECTURE.md for complete Action patterns, lease management, and orchestration details.
...
> See MIXIN_ARCHITECTURE.md for detailed wrapper composition and MRO information.
