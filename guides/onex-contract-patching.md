...
<!-- Migrated from omnibase_core:docs/guides/CONTRACT_PATCHING_GUIDE.md on 2026-09-02 -->
...
- Contract Profile Guide - Profile factory reference
- ONEX Four-Node Architecture - Node types
- Effect Subcontract Guide - Effect handlers
- Node Building Guide - Building nodes
