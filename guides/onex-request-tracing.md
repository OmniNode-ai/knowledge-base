...
<!-- Migrated from omnibase_core:docs/guides/REQUEST_TRACING.md on 2026-09-02 -->
...
- ProtocolHandlerContext - Handler context protocol
- ModelEventEnvelope - Envelope model
- ModelHandlerOutput - Handler output model
- ModelDispatchResult - Dispatch result model
- THREADING.md - Thread safety considerations
