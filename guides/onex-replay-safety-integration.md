...
status: current
date: "2026-09-02"
title: "Replay Safety Integration Guide"
topics:
  - omnibase-core
  - replay
  - safety
...
<!-- Migrated from omnibase_core:docs/guides/replay/REPLAY_SAFETY_INTEGRATION.md on 2026-09-02 -->
...
```python
# Wrong - exposes PII
context={"user_email": "john.doe@example.com"}  # sanitization-ok: illustrative example value, not a real address
...
- THREADING.md - Thread safety patterns
- Node Building Guide - Node architecture
- Effect Node Tutorial - Effect patterns
