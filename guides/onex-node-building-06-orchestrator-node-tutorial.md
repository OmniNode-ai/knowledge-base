...
status: current
date: "2026-09-02"
title: "ORCHESTRATOR Node Tutorial: Build a Data Processing Pipeline"
topics:
  - omnibase-core
  - node
  - building
...
<!-- Migrated from omnibase_core:docs/guides/node-building/06_ORCHESTRATOR_NODE_TUTORIAL.md on 2026-09-02 -->
...
See ONEX Four-Node Architecture for detailed explanation.
...
- Node Types Overview - Understanding the 4-node architecture
- ONEX Four-Node Architecture - Complete architecture guide
- Migration Guide - Migrating from v0.3.x to v0.4.0
- Patterns Catalog - Common orchestration patterns
