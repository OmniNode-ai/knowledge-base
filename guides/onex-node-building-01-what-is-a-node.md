...
<!-- Migrated from omnibase_core:docs/guides/node-building/01_WHAT_IS_A_NODE.md on 2026-09-02 -->
...
> See Handler Architecture and MIXIN_ARCHITECTURE.md for complete details.
...
**Next step**: Learn about the four node types -->
