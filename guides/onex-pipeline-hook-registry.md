...
status: current
date: "2026-09-02"
title: "Pipeline Runner and Hook Registry Guide"
topics:
  - omnibase-core
  - pipeline
  - hook
...
<!-- Migrated from omnibase_core:docs/guides/PIPELINE_HOOK_REGISTRY.md on 2026-09-02 -->
...
For detailed threading guidance, see Threading Guide.
...
**See also**: CHANGELOG.md for full release notes and additional migration examples.
...
- Threading Guide - Detailed thread safety guidance
- ONEX Four-Node Architecture - Node type overview
