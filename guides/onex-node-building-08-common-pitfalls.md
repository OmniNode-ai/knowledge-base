...
status: current
date: "2026-09-02"
title: "Common Pitfalls - What to Avoid When Building Nodes"
topics:
  - omnibase-core
  - node
  - building
...
<!-- Migrated from omnibase_core:docs/guides/node-building/08_COMMON_PITFALLS.md on 2026-09-02 -->
...
class BadNode(NodeCompute):
    ...
    async def process(self, input_data: dict[str, Any]) -> dict[str, Any]:
        ...
        await self.email_service.send("result@example.com", result)  # sanitization-ok: illustrative example value, not a real address
...
- Node Building Guide - Complete implementation tutorials
