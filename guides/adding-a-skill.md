...
topics: ["omniclaude", "skills", "how-to"]
refs: []
---
...
See [Skill Lifecycle](../architecture/omniclaude-skill-lifecycle.md) for the full decision rule and examples.
...
3. Check the tree Claude Code actually loads — not the plugin cache, which for a
   `directory`-source marketplace is never read:
...
- Skill authoring guide: [Authoring an ONEX Skill](authoring-an-onex-skill.md)
- Workflow entrypoints: `plugins/onex/skills/*/SKILL.md`
- [Skill Lifecycle](../architecture/omniclaude-skill-lifecycle.md) — when to put logic in omnimarket instead
