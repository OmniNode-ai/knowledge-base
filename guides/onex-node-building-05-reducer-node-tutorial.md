...
status: current
date: "2026-09-02"
title: "REDUCER Node Tutorial: Build a Pure FSM Metrics Aggregator"
topics:
  - omnibase-core
  - node
  - building
...
<!-- Migrated from omnibase_core:docs/guides/node-building/05_REDUCER_NODE_TUTORIAL.md on 2026-09-02 -->
...
**Prerequisites**: What is a Node?, EFFECT Node Tutorial
...
2. Migrate to YAML-driven FSM contracts (see MIGRATING_TO_DECLARATIVE_NODES.md)
...
See also Node Purity Guarantees for enforcement details.
...
- MODEL_INTENT_ARCHITECTURE.md - Intent pattern details
...
- ORCHESTRATOR Node Tutorial - Master workflow coordination
- Patterns Catalog - Common patterns and advanced Intent handling
