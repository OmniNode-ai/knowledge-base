...
status: current
date: "2026-09-02"
title: "Thread Safety in Omnibase Core"
topics:
  - omnibase-core
  - threading
refs: []
...
<!-- Migrated from omnibase_core:docs/guides/THREADING.md on 2026-09-02 -->
...
| `threading.Timer` | The `EFFECT_TIMEOUT_BEHAVIOR` subcontract. See EFFECT_TIMEOUT_BEHAVIOR.md. |
...
operation execution. See EFFECT_TIMEOUT_BEHAVIOR.md
...
- [ ] **Handler timeout <= operation timeout**: Individual call timeouts fire before
      the overall operation timeout. See EFFECT_TIMEOUT_BEHAVIOR.md.
...
| Topic | Document |
|-------|----------|
| Effect timeout specification | EFFECT_TIMEOUT_BEHAVIOR.md |
| Four-node architecture | ONEX_FOUR_NODE_ARCHITECTURE.md |
| Debug thread safety constant | constants_effect.py |
| Effect execution mixin | mixin_effect_execution.py |
