...
<!-- Migrated from omnibase_core:docs/guides/mixin-development/README.md on 2026-09-02 -->
...
**Related**: Mixin Architecture, Node Building Guide
...
- **Architecture Overview** - Three-layer mixin architecture
- Understanding node type constraints and separation of concerns

### Step-by-Step Guides

1. **Creating Mixins** - Complete step-by-step guide to creating a new mixin
2. **Mixin YAML Schema** - Comprehensive YAML schema reference
3. **Pydantic Models** - Creating and validating backing models
4. **Mixin Integration** - Integrating mixins into nodes
5. **Best Practices** - Patterns, tools, and utilities

## Quick Start

**Never created a mixin before?** Start here:

1. Read Mixin Architecture (10 min)
2. Follow Creating Mixins guide (30 min)
3. Reference YAML Schema as needed
4. Create Pydantic Models (15 min)
5. Integrate into a node (10 min)

**Created mixins before?** Jump to:

- Best Practices for advanced patterns
- YAML Schema for quick reference
- Pydantic Models for model patterns
...
|-------|---------|-----------------|
| `mixin_health_check` | Health monitoring | Creating Mixins |
| `mixin_introspection` | Node discovery | YAML Schema |
| `mixin_event_handling` | Event bus integration | Integration |
| `mixin_service_resolution` | Service discovery | Best Practices |
| `mixin_performance_monitoring` | Metrics collection | Creating Mixins |
| `mixin_request_response` | Request/response patterns | Integration |
...
**See**: Creating Mixins for complete example
...
**See**: Pydantic Models for validation patterns
...
**See**: Best Practices for comprehensive testing strategies

## Getting Help

- **Architecture Questions**: See Mixin Architecture
- **YAML Syntax**: See YAML Schema
- **Pydantic Issues**: See Pydantic Models
- **Integration Problems**: See Mixin Integration
...
- **New to mixins?** → Mixin Architecture
- **Ready to create?** → Creating Mixins
- **Need schema reference?** → YAML Schema
- **Creating models?** → Pydantic Models
- **Integrating into nodes?** → Mixin Integration
- **Want best practices?** → Best Practices
...
- Mixin Architecture - Architectural overview
- Subcontract Architecture - Implementation patterns
- Node Building Guide - Building nodes with mixins
