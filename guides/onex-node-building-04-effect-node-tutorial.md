...
status: current
date: "2026-09-02"
title: "EFFECT Node Tutorial: Build a File Backup System"
topics:
  - omnibase-core
  - node
  - building
...
<!-- Migrated from omnibase_core:docs/guides/node-building/04_EFFECT_NODE_TUTORIAL.md on 2026-09-02 -->
...
- REDUCER Node Tutorial - Learn data aggregation
- ORCHESTRATOR Node Tutorial - Master workflow coordination
- Patterns Catalog - Common EFFECT patterns
