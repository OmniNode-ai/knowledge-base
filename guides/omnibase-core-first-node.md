...
<!-- Migrated from omnibase_core:docs/getting-started/FIRST_NODE.md on 2026-09-02 -->
...
- Quick Start -- See all four node kinds side by side
- Node Archetypes Reference -- Complete reference for each node type
- Handler Contract Guide -- Advanced handler contract features
- Node Building Guide -- In-depth guide for each node type
