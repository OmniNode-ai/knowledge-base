...
status: current
date: "2026-09-02"
title: "ONEX Error Handling Best Practices"
topics:
  - omnibase-core
  - error
  - handling
...
<!-- Migrated from omnibase_core:docs/conventions/ERROR_HANDLING_BEST_PRACTICES.md on 2026-09-02 -->
...
For complete error code standards including valid/invalid examples and best practices, see Error Code Standards.
...
- **See**: ADR-012: Validator Error Handling
...
- Error Code Standards - Complete error code format specification
- Centralized Error Pattern - Single source of truth for error code validation
- Centralized Exception Groups - Standardized exception type tuples
- Error Handling Decorators - Boilerplate-eliminating decorators
- ADR-012: Validator Error Handling - Decision rationale and Pydantic compatibility
- Node Building Guide - Node validation patterns
- Reducer Output Model - Reference implementation
