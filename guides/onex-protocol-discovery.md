...
status: current
date: "2026-09-02"
title: "Protocol Discovery Guide"
topics:
  - omnibase-core
  - protocol
  - discovery
...
<!-- Migrated from omnibase_core:docs/guides/PROTOCOL_DISCOVERY_GUIDE.md on 2026-09-02 -->

# Protocol Discovery Guide

> **Version**: 0.4.0
> **Last Updated**: 2025-12-08
> **Related**: CLAUDE.md, Node Building Guide
...
- **Node Building Guide**: How to build ONEX nodes
- **Threading Guide**: Thread safety in ONEX
- **Migration Guide**: Migrating to v0.4.0
