...
status: current
date: "2026-09-02"
title: "Patterns Catalog -- Common ONEX Node Patterns"
topics:
  - omnibase-core
  - node
  - building
...
<!-- Migrated from omnibase_core:docs/guides/node-building/07_PATTERNS_CATALOG.md on 2026-09-02 -->
...
class TestHandlerSchemaValidator:
    def test_valid_data_passes(self) -> None:
        ...
        request = ModelValidationRequest(
            data={"user_id": "u123", "email": "test@example.com"},  # sanitization-ok: illustrative example value, not a real address
            rules=[
