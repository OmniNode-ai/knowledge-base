...
status: current
date: "2026-09-02"
title: "Mixin YAML Schema Reference"
topics:
  - omnibase-core
  - mixin
  - development
...
<!-- Migrated from omnibase_core:docs/guides/mixin-development/02_MIXIN_YAML_SCHEMA.md on 2026-09-02 -->
...
**Related**: Creating Mixins, Mixin Architecture
...
- **Creating Mixins**: Step-by-step creation guide
- **Pydantic Models**: Creating backing models
- **Mixin Integration**: Integrating into nodes
- **Best Practices**: Advanced patterns

---

**Need help?** See Mixin Architecture for architectural overview.
