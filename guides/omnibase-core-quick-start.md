...
<!-- Migrated from omnibase_core:docs/getting-started/QUICK_START.md on 2026-09-02 -->
...
| Goal | Resource |
|------|----------|
| Build a complete node end-to-end | Build Your First Node |
| Understand each node type in depth | Node Archetypes Reference |
| Learn handler contract features | Handler Contract Guide |
| Advanced node patterns | Node Building Guide |
| ONEX architecture overview | Four-Node Architecture |
