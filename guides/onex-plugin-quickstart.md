> Migrated from omniclaude:QUICKSTART.md on 2026-09-01 (OMN-16609).
...
[CLAUDE.md](https://github.com/OmniNode-ai/omniclaude/blob/dev/CLAUDE.md) — it is internal OmniNode tooling, not part of the public plugin below.
...
- [CLAUDE.md](https://github.com/OmniNode-ai/omniclaude/blob/dev/CLAUDE.md) — development/architecture reference for OmniNode's internal tooling (insider-oriented; assumes an OmniNode canonical-clone workspace)
- [plugins/onex-delegate/skills/delegate/SKILL.md](https://github.com/OmniNode-ai/omniclaude/blob/dev/plugins/onex-delegate/skills/delegate/SKILL.md) — the delegate skill's full usage reference
- [plugins/onex-delegate/skills/cloud_delegate/SKILL.md](https://github.com/OmniNode-ai/omniclaude/blob/dev/plugins/onex-delegate/skills/cloud_delegate/SKILL.md) — dashboard-key cloud delegation and receipt-file reference
- [plugins/onex-delegate/plugin-compat.yaml](https://github.com/OmniNode-ai/omniclaude/blob/dev/plugins/onex-delegate/plugin-compat.yaml) — source of truth for the `onex` CLI version pins above
