...
status: current
date: "2026-09-02"
title: "Enums API Reference - omnibase_core"
topics:
  - omnibase-core
  - api
  - enums
...
<!-- Migrated from omnibase_core:docs/reference/api/enums.md on 2026-09-02 -->
...
**See Also**: [EnumNodeType](#enumnodetype), [EnumHandlerTypeCategory](#enumhandlertypecategory), Migration Guide
...
- Nodes API - Node class reference
- Models API - Model class reference
- Error Handling - Error handling patterns
- Node Building Guide - Usage examples
- EnumNodeKind Migration Guide - Migration from EnumNodeType to EnumNodeKind
- ONEX Four-Node Architecture - Architecture overview
