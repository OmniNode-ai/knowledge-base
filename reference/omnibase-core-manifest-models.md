...
<!-- Migrated from omnibase_core:docs/reference/MANIFEST_MODELS.md on 2026-09-02 -->
...
- **Mixin Metadata Tests**: ../../tests/unit/models/core/test_model_mixin_metadata.py - 39 tests
- **Docker Compose Manifest Tests**: ../../tests/unit/models/docker/test_model_docker_compose_manifest.py - 26 tests
...
- Mixin System Architecture - Complete mixin system documentation
- Validation Framework - Pydantic validation patterns
