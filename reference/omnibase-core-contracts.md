...
<!-- Migrated from omnibase_core:docs/reference/contracts.md on 2026-09-02 -->

> **Note**: For authoritative coding rules, see CLAUDE.md.
...
ORCHESTRATOR nodes coordinate workflows. **Important**: ORCHESTRATOR nodes cannot return typed results - they can only emit events and intents. See CLAUDE.md for details.
...
| Topic | Document |
|-------|----------|
| Coding standards | CLAUDE.md (authoritative source) |
| Handler contracts | Handler Contract Guide |
| Node architecture | ONEX Four-Node Architecture |
| Node kind enum | EnumNodeKind Migration Guide |
| Node building | Node Building Guide |
| Node templates | COMPUTE Template / EFFECT Template / REDUCER Template / ORCHESTRATOR Template |
