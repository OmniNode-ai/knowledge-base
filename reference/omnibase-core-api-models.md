...
status: current
date: "2026-09-02"
title: "Models API Reference - omnibase_core"
topics:
  - omnibase-core
  - api
  - models
...
<!-- Migrated from omnibase_core:docs/reference/api/models.md on 2026-09-02 -->
...
intent = ModelIntent(
    ...
    target="user.created",
    payload={"user_id": "123", "email": "user@example.com"},  # sanitization-ok: illustrative example value, not a real address
    priority=5
)
```
...
- Enums API - Enumeration reference
