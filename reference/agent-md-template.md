...
status: current
date: "2026-08-25"
title: "AGENT.md Template"
topics: [agent-md, llm-navigation, cross-repo-standard]
refs: []
---

# AGENT.md Template

Canonical template for `AGENT.md` files across all ONEX repos. `AGENT.md` is an LLM
navigation index — it tells agents where to look, not what is there.

**Source**: omnibase_core `docs/standards/AGENT_MD_TEMPLATE.md`.
...
- Shared platform standards: the org's shared development-standards document
