...
status: current
date: "2026-09-02"
title: "Nodes API Reference - omnibase_core"
topics:
  - omnibase-core
  - api
  - nodes
...
<!-- Migrated from omnibase_core:docs/reference/api/nodes.md on 2026-09-02 -->
...
**Location**: `omnibase_core.nodes.node_service_effect`
...
**Location**: `omnibase_core.nodes.node_service_reducer`
...
**Location**: `omnibase_core.nodes.node_service_orchestrator`
...
**Important**: ONEX node instances are **NOT thread-safe**. Do not share node instances across threads. See Threading Guide for details.
...
- Node Building Guide - Complete tutorials
