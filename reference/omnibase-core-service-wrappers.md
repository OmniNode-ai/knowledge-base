...
status: current
date: "2026-09-02"
title: "ONEX Service Wrappers - Pre-Composed Production-Ready Node Classes"
topics:
  - omnibase-core
  - service
  - wrappers
...
<!-- Migrated from omnibase_core:docs/reference/SERVICE_WRAPPERS.md on 2026-09-02 -->
...
```
from omnibase_core.models.services import ModelServiceOrchestrator
...
```
from omnibase_core.models.services import ModelServiceReducer
