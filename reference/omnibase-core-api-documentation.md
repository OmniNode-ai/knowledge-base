...
status: current
date: "2026-09-02"
title: "ONEX Core Public API Reference"
topics:
  - omnibase-core
  - api
  - documentation
...
<!-- Migrated from omnibase_core:docs/reference/API_DOCUMENTATION.md on 2026-09-02 -->
...
This is not a backwards-compatible library. Interfaces change without deprecation periods. Breaking changes are always acceptable per the repo invariants.
...
**Critical**: Use `ModelONEXContainer` in node constructors, never `ModelContainer`. See Container Types.
...
See Error Handling Best Practices for complete guidelines.
...
For multi-threaded patterns, see Threading Guide.
