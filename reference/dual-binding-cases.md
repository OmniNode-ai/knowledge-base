...
status: current
date: "2026-08-25"
title: "Dual-Binding Test Cases — the Harness Convention"
topics: [testing, seam-binding, integration-testing, occ, golden-chain]
refs: []
---

# Dual-binding cases — the harness convention

> **Source**: onex_change_control `docs/standards/DUAL_BINDING_CASES.md`. Migrated to the
> knowledge base 2026-08-25; verified live that the cited engine and harness modules still
> exist at the stated paths. No content drift found.

Authority for the shape itself: the repo's `schemas/occ_contract_v1.schema.yaml`.
...
|---|---|---|
| mock-bound | `pytest -m 'not integration'` (or no marker filter) | `tests/test_golden_chain_*.py` — mock at a *named boundary*, e.g. patching a governance-emitter internal |
...
*fast* leg — this makes a whole class of mock/real drift unrepresentable rather
