...
status: current
date: "2026-09-02"
title: "NodeEffect Contract Examples"
topics:
  - omnibase-core
  - example
  - effect
...
<!-- Migrated from omnibase_core:examples/contracts/effect/README.md on 2026-09-02 -->
...
input_data = ModelEffectInput(
    operation_data={
        "user_id": "usr_12345",
        "email": "john@example.com",  # sanitization-ok: illustrative example value, not a real address
