...
status: current
date: "2026-09-02"
title: "Node Archetypes Reference"
topics:
  - omnibase-core
  - node
  - archetypes
...
<!-- Migrated from omnibase_core:docs/reference/node-archetypes.md on 2026-09-02 -->
...
> **Note**: For authoritative coding rules and standards, see CLAUDE.md. This documentation provides explanations and examples that supplement those rules.
...
Setting a forbidden field raises `ModelOnexError` at construction time. See Handler Output Constraints.
...
| Architecture overview | ONEX Four-Node Architecture |
| Node types guide | Node Types |
| COMPUTE tutorial | COMPUTE Node Tutorial |
| EFFECT tutorial | EFFECT Node Tutorial |
| REDUCER tutorial | REDUCER Node Tutorial |
| ORCHESTRATOR tutorial | ORCHESTRATOR Node Tutorial |
| Container types | Container Types |
| Execution shapes | Canonical Execution Shapes |
