...
status: accepted
date: "2026-09-02"
title: "Envelope Flow Architecture"
topics:
  - omnibase-core
  - envelope
  - flow
...
<!-- Migrated from omnibase_core:docs/architecture/ENVELOPE_FLOW_ARCHITECTURE.md on 2026-09-02 -->
...
- ONEX Four-Node Architecture - Core architectural patterns
- Model Intent Architecture - Intent emission from Reducers
- Model Action Architecture - Action emission from Orchestrators
- Contract System - Contract-based communication
