...
status: accepted
date: "2026-09-02"
title: "ONEX Four-Node Architecture Documentation"
topics:
  - omnibase-core
  - four
  - node
...
<!-- Migrated from omnibase_core:docs/architecture/ONEX_FOUR_NODE_ARCHITECTURE.md on 2026-09-02 -->
...
> **Status**: Production
> **See Also**: ONEX Terminology Guide for canonical definitions of all ONEX concepts.
...
**See Also**:
- Canonical Execution Shapes - Allowed orchestrator patterns
- ModelHandlerOutput Validation - Enforcement code
