...
status: accepted
date: "2026-09-02"
title: "Payload Type Architecture"
topics:
  - omnibase-core
  - payload
  - type
...
<!-- Migrated from omnibase_core:docs/architecture/PAYLOAD_TYPE_ARCHITECTURE.md on 2026-09-02 -->
...
**See Also**: ModelAction Typed Payloads for comprehensive usage examples and the semantic action reference table.
