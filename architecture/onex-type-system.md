...
<!-- Migrated from omnibase_core:docs/architecture/TYPE_SYSTEM.md on 2026-09-02 -->
...
- Pydantic Best Practices -- ConfigDict patterns and model standards
- Contract System -- Contract architecture using these types
