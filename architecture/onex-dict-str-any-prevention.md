...
status: accepted
date: "2026-09-02"
title: "Dict[str, Any] Prevention Guide"
topics:
  - omnibase-core
  - dict
  - str
...
<!-- Migrated from omnibase_core:docs/architecture/DICT_STR_ANY_PREVENTION.md on 2026-09-02 -->
...
- ModelAction Typed Payloads - Action payload implementation guide
- Type System Architecture - Core type patterns
- ModelSchemaValue Type Definition
- ONEX Terminology
