...
<!-- Migrated from omnibase_core:docs/architecture/EFFECT_TIMEOUT_BEHAVIOR.md on 2026-09-02 -->
...
- THREADING.md - Thread safety guidelines
- MixinEffectExecution - Implementation source
- constants_effect.py - Timeout constants
