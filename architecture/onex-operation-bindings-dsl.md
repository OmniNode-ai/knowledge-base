...
<!-- Migrated from omnibase_core:docs/contracts/OPERATION_BINDINGS_DSL.md on 2026-09-02 -->
...
- Handler Contract Guide - Handler contract structure and behavior descriptors
- ONEX Four-Node Architecture - Node types and data flow
- Node Building Guide - Building ONEX nodes
