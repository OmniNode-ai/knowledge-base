...
status: accepted
date: "2026-09-02"
title: "ONEX Ecosystem Directory Structure"
topics:
  - omnibase-core
  - ecosystem
  - directory
...
<!-- Migrated from omnibase_core:docs/architecture/ECOSYSTEM_DIRECTORY_STRUCTURE.md on 2026-09-02 -->
...
authors = [{name = "OmniNode Team", email = "team@example.com"}]  # sanitization-ok: illustrative packaging metadata
license = "MIT"
readme = "README.md"
