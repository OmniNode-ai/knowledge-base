...
status: accepted
date: "2026-09-02"
title: "ONEX Anti-Patterns Documentation"
topics:
  - omnibase-core
  - anti
  - patterns
...
<!-- Migrated from omnibase_core:docs/patterns/ANTI_PATTERNS.md on 2026-09-02 -->
...
- CLAUDE.md -- Authoritative coding standards
- Node Archetypes Reference -- Node type specifications
- Handler Contract Guide -- Handler contract authoring
- Error Handling Best Practices -- Error patterns
- Pydantic Best Practices -- Model standards
