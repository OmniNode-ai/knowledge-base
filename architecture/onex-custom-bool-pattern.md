...
status: accepted
date: "2026-09-02"
title: "Custom `__bool__` Pattern for Result Models"
topics:
  - omnibase-core
  - custom
  - bool
...
<!-- Migrated from omnibase_core:docs/patterns/CUSTOM_BOOL_PATTERN.md on 2026-09-02 -->
...
- ONEX Four-Node Architecture - Node types and result handling
- Error Handling Best Practices - Result model patterns
