...
status: accepted
date: "2026-09-02"
title: "ModelAction Architecture"
topics:
  - omnibase-core
  - model
  - action
...
<!-- Migrated from omnibase_core:docs/architecture/MODEL_ACTION_ARCHITECTURE.md on 2026-09-02 -->

# ModelAction Architecture

> **See Also**: ONEX Terminology Guide for canonical definitions. This document expands on the **Action** concept from the terminology guide.
...
- **ONEX Four-Node Architecture** - Node responsibilities and data flow
- **Lease Management Pattern** - Single-writer semantics in detail
- **Orchestrator Node Template** - Implementation patterns
- **Subcontract Architecture** - Workflow subcontracts
- **Event-Driven Architecture** - Action publication patterns
