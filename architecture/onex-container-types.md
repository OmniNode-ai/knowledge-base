...
status: accepted
date: "2026-09-02"
title: "Container Types in omnibase_core"
topics:
  - omnibase-core
  - container
  - types
...
<!-- Migrated from omnibase_core:docs/architecture/CONTAINER_TYPES.md on 2026-09-02 -->
...
Handler Contract Guide for handler authoring details.
...
- Dependency Injection Architecture - Full DI patterns
- Models API Reference - Complete model API
- Node Building Guide - Node construction patterns
