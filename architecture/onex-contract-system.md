...
<!-- Migrated from omnibase_core:docs/architecture/CONTRACT_SYSTEM.md on 2026-09-02 -->
...
See Handler Contract Guide for full details.
...
- Handler Contract Guide -- Full ModelHandlerContract reference
- ONEX Four-Node Architecture -- Node kind definitions
- Canonical Execution Shapes -- Valid data flow patterns
- Container Types -- ModelContainer[T] vs ModelONEXContainer
- Dependency Injection -- Protocol-based service resolution
- Subcontract Architecture -- Subcontract design details
- Type System -- Type conventions (PEP 604)
- Node Building Guide -- How to build nodes with contracts
