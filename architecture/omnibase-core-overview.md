...
status: accepted
date: "2026-09-02"
title: "Architecture Overview - omnibase_core"
topics:
  - omnibase-core
  - overview
refs: []
...
<!-- Migrated from omnibase_core:docs/architecture/overview.md on 2026-09-02 -->
...
- Four-Node Architecture - Detailed node architecture
- Dependency Injection - Container patterns
- Contract System - Model contracts
- Type System - Typing patterns
- Node Building Guide - Implementation tutorials
- API Reference - Complete API documentation

## Epic 3 Handler Classification Results

- File I/O Services Classification — ServiceDiffFileStore, ServiceFileSink, OncpBuilder, OncpReader assessed; all KEEP AS SERVICE
