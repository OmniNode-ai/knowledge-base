...
<!-- Migrated from omnibase_core:docs/architecture/DEPENDENCY_INJECTION.md on 2026-09-02 -->
...
See Container Types for the complete reference with examples.
...
- Container Types -- ModelContainer[T] vs ModelONEXContainer with full examples
- Contract System -- YAML contract definitions and validation
- Type System -- Type conventions and protocol typing
- ONEX Four-Node Architecture -- Node kinds and their roles
- Node Building Guide -- How to build nodes
