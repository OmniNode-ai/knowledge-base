...
<!-- Migrated from omnibase_core:docs/architecture/MIXIN_ARCHITECTURE.md on 2026-09-02 -->

# ONEX Mixin Architecture

**Status**: Active
**Last Updated**: 2026-02-14
**Related Documents**: Subcontract Architecture, Mixin Development Guide
...
- **Subcontract Architecture**: Detailed subcontract implementation patterns
- **Mixin Development Guide**: Step-by-step guide to creating mixins
- **ONEX Four-Node Architecture**: Core ONEX architecture patterns
...
**Next Steps**:
- Read the Mixin Development Guide to learn how to create mixins
- See the Subcontract Architecture for implementation patterns
