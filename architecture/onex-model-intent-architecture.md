...
status: accepted
date: "2026-09-02"
title: "ModelIntent Architecture"
topics:
  - omnibase-core
  - model
  - intent
...
<!-- Migrated from omnibase_core:docs/architecture/MODEL_INTENT_ARCHITECTURE.md on 2026-09-02 -->

# ModelIntent Architecture

> **See Also**: ONEX Terminology Guide for canonical definitions. This document expands on the **Intent** concept from the terminology guide.
...
ModelIntent(
    ...
    payload={
        ...
        "recipients": ["admin@example.com"],  # sanitization-ok: illustrative example value, not a real address
