...
status: superseded
date: "2026-08-18"
title: "Event-Driven Agent Routing Architecture Proposal"
...
**Implementation**: `src/omniclaude/lib/core/manifest_injector.py` + `intelligence_event_client.py` (moved from `agents/lib/`)
...
**Location**: `src/omniclaude/lib/core/routing_event_client.py` (moved from `agents/lib/`; this proposal's `agents/lib/` path is superseded)
...
1. ✅ Done, at `src/omniclaude/lib/core/routing_event_client.py` (not `agents/lib/` as originally proposed)
...
- Agent Traceability (`docs/observability/AGENT_TRACEABILITY.md` in the omniclaude repo) - Observability architecture (deprecated); not yet migrated to this knowledge base
