...
<!-- Migrated from omnibase_core:docs/architecture/HANDLER_ARCHITECTURE.md on 2026-09-02 -->
...
| Topic | Document |
|-------|----------|
| Handler Contract Model | Handler Contract Guide |
...
| Handler Conversion | Handler Conversion Guide |
| Dependency Injection | Dependency Injection |
| Threading | Threading Guide |
