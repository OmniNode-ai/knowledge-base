...
status: accepted
date: "2026-06-24"
title: "Skill Lifecycle: When a Skill Stays in omniclaude vs. Moves to omnimarket"
topics: ["omniclaude", "skills", "omnimarket"]
refs: []
---
...
- `omnimarket` (OmniNode-ai) — canonical home for workflow packages
- [Adding a Skill](../guides/adding-a-skill.md) — step-by-step skill creation guide
- [omniclaude charter](omniclaude-repo-charter.md) — full ownership boundary declaration
