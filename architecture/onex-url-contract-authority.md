...
<!-- Migrated from omnibase_core:docs/architecture/URL_CONTRACT_AUTHORITY.md on 2026-09-02 -->
...
| `internal_infra` | Self-hosted endpoints (projection API, Redpanda, the secrets manager). No public default; `endpoint_url: null`. |
...
```yaml
- repo: https://github.com/OmniNode-ai/omnibase_core  # sanitization-ok: omnibase_core is a public repository
