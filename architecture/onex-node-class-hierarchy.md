...
status: accepted
date: "2026-09-02"
title: "Node Class Hierarchy Guide"
topics:
  - omnibase-core
  - node
  - class
...
<!-- Migrated from omnibase_core:docs/architecture/NODE_CLASS_HIERARCHY.md on 2026-09-02 -->
...
To add features, **compose with mixins manually**. This pattern forms the foundation for ONEX's declarative node architecture (v0.4.0), where nodes define their behavior through configuration rather than inheritance. See ONEX Four-Node Architecture for the declarative approach.
...
- **Node Building Guide** - Step-by-step tutorials for building nodes
- **COMPUTE Node Tutorial** - Practical COMPUTE node example
- **EFFECT Node Tutorial** - Practical EFFECT node example
- **ONEX Four-Node Architecture** - Understanding the 4-node pattern
- **Mixin Architecture** - Deep dive into mixin system
- **Container Types** - ModelContainer vs ModelONEXContainer
- **Error Handling Best Practices** - Structured error handling
- **Threading Guide** - Thread safety considerations
...
**Ready to build?** → Node Building Guide ⭐
