...
status: accepted
date: "2026-09-02"
title: "ONEX Canonical Execution Shapes"
topics:
  - omnibase-core
  - canonical
  - execution
...
<!-- Migrated from omnibase_core:docs/architecture/CANONICAL_EXECUTION_SHAPES.md on 2026-09-02 -->
...
> **See Also**:
> - ADR-004: Registration Trigger Architecture for architectural decision rationale
...
| Document | Purpose |
|----------|---------|
| **Execution Shape Examples** | Practical code examples for each canonical shape |
| ONEX Four-Node Architecture | Complete architecture overview |
| ModelIntent Architecture | Intent pattern for Reducer → Effect |
| ModelAction Architecture | Action pattern for Orchestrator → nodes |
| Node Purity Guarantees | Purity enforcement for COMPUTE/REDUCER |
| Node Types Guide | When to use each node type |
| Node Building Guide | How to implement nodes |
| ADR-004: Registration Trigger Architecture | Architectural decision for registration triggers |

### See Also

For practical, runnable code examples demonstrating each execution shape, see **Execution Shape Examples**.
