...
status: accepted
date: "2026-09-02"
title: "Dependency Inversion in ONEX Architecture"
topics:
  - omnibase-core
  - dependency
  - inversion
...
<!-- Migrated from omnibase_core:docs/architecture/DEPENDENCY_INVERSION.md on 2026-09-02 -->
...
- Protocol Architecture - Complete protocol inventory and patterns
- Dependency Injection - Container-based DI patterns
- ONEX Four-Node Architecture - Node type responsibilities
- Container Types - ModelONEXContainer vs ModelContainer
