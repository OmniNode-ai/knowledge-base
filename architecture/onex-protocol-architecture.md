...
<!-- Migrated from omnibase_core:docs/architecture/PROTOCOL_ARCHITECTURE.md on 2026-09-02 -->
...
- `omnibase_infra` implements SPI and runtime infrastructure using concrete
  libraries such as Kafka, Postgres, a secrets manager, Docker, and deployment tooling.
